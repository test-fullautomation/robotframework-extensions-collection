...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "./../RobotframeworkExtensions")))

# print("(debug) sys.path:\n" + '\n'.join(sys.path))

# -- Project information -----------------------------------------------------

project = 'Robotframework Extensions Collection'
copyright = '2021, Queckenstedt Holger (XC-CT/ECA3)'
...
latex_documents = [('index', 'Robotframework-Extensions-Collection.tex', project, author, 'manual', False)]

# extend the default (to enable deeper nestings (mostly interface definitions)
latex_elements = {
    'maxlistdepth': '10'
}
